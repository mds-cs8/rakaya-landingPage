                       ...
                       <small id="name2_msg"></small>
                        ...
                        <div class="password">
                            ...
                            <div class="pass2">
                                ...
                                <input type="text" name="repassword" id="repassword" placeholder="••••••••" class="bg-gray-50  text-gray-900 sm:text-sm rounded-md block w-full p-2.5 dark:placeholder-gray-400 dark:text-white inputBoxs" required>
                        ...
                        <div class="submit">
                            ...
                            <button class="editProfileButton" type="submit" id="save" name="save" class=" font-medium rounded-lg text-sm px-2 py-2 text-center">حفظ</button>
...
>>>>>>> 6b734d24230696dec4ed5da5c9397c844d6e1cfd
                </div>
