                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="login.php" method="POST">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" placeholder="name@google.com" id="email" class="inputBoxs" value="<?php echo $mail ?> " required>
                        </div>
                        <div>
                            <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">كلمة المرور</label>
                            <input type="password" name="password" id="password" placeholder="••••••••" class="inputBoxs " required value="<?php echo $pass ?>">
                        </div>
                        ...
                        <div class="flex items-center justify-between  ">
                            ...
                            <a href="forgot-password.php" class="text-sm font-medium text-primary-600 hover:underline dark:text-primary-500">نسيت
                                كلمة المرور</a>
                        </div>
                        ...
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            لم تسجل بعد ؟ <a href="signUp.php" class="font-medium text-gray-900 hover:underline dark:text-primary-500">سجل الآن</a>
                        </p>
                    </form>
                </div>
            </div>
